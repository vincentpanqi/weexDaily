...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/4db5decf59f62c25d707bebdd31fa4ef', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/4db5decf59f62c25d707bebdd31fa4ef',undefined,undefined)
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        onSliderItemClick: function onSliderItemClick(e) {
	            ...
	            var vm = this;
	            var params = {
	                'url': this.baseURL + 'carouse-list.js?id=' + itemid + "&title=" + title,
	                'animated': 'true'
	            };
	        ...
	        openSerialDetail: function openSerialDetail(id) {
	            var vm = this;
	            var params = {
	                'url': this.baseURL + 'serial-detail.js?id=' + id,
	                'animated': 'true'
	            };
	            navigator.push(params, function (e) {});
	        },
	        openQuestionDetail: function openQuestionDetail(id) {
	            var vm = this;
	            var params = {
	                'url': this.baseURL + 'question-detail.js?id=' + id,
	                'animated': 'true'
	            };
	            navigator.push(params, function (e) {});
	        }
